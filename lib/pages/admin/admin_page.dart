...
class _KasirPageState extends State<AdminPage> {
  ...
  void initState() {
    ...
    _pages = [
      ...
      RoomTypeListPage(), // Pastikan class BookingRoomPage sudah didefinisikan
      UserManagementPage(), // Pastikan class HistoryTransactionPage sudah didefinisikan
      ProfilPage(
          userData:
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            _buildNavItem(1, Icons.hotel, 'Rooms'),
            _buildNavItem(2, Icons.people_alt, 'Users'),
